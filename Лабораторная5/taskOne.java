package com.company.Лабораторная5;
...
class TaskFive{
    ...
    public static void main(String[] args){
        DrawFigures dc = new DrawFigures();
    }
}
...
//            int[] a = {10, 100, 55};
//            int[] b = {50, 50, 150};
//            int randIntOne = rand.nextInt(1200);
//            int randIntTwo = rand.nextInt(600);
//
//            for (int jj = 0; jj < a.length; jj++){
//                a[jj] += randIntOne;
//                b[jj] += randIntTwo;
//            }
//            gr.drawPolygon(a, b, a.length);
//            gr.setColor(Color.BLUE);
//            gr.fillPolygon(a, b, a.length);
        }
